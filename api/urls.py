...
from .views import list_gate_entry_api,create_gate_entry_api,show_tick_api,toggle_tick
...
urlpatterns=[
    ...
    path('tick-status/<str:regno>/<str:toggle>',toggle_tick,name='tick-toggle'),
